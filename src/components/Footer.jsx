  ...
  return (
    <footer className="bg-white border-t border-gray-200 pt-12">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:underline">CALL NOW: +84 886 460 385</a></li>
          ...
          {/* LEGAL AREA */}
          <div>
            <h3 className="font-bold text-xl mb-4">LEGAL AREA</h3>
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:underline">CALIFORNIA PRIVACY RIGHTS</a></li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              {/* Replace with your own SVGs or icon components */}
            ...
            {/* Accessibility icons (optional, replace as needed) */}
        ...
        {/* Bottom logos and copyright */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pb-4">
          <div className="flex-1 flex justify-center md:justify-start gap-8 opacity-70">
      ...
      {/* Bottom bar */}
      <div className="w-full py-4 text-white text-center font-medium bg-gradient-to-br from-[#fc00ff] to-[#00dbde] mt-4">
        <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-4">
          ...
          <div className="mt-2 md:mt-0">
            COPYRIGHT © {new Date().getFullYear()} DESiES
          </div>
        </div>
      </div>
    </footer>
